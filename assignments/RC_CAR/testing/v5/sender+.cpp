/*
//RC CAR transmitter code using joystick.
CHANGES:
- EMERGENCY STOP (WIRE UP BUTTON) 
- ROUNDING Y VAL TO 0 IF WITHIN +- 10 
...
// Convert integers to strings and store in myData.a and myData.b
sprintf(myData.a, "%d", parsedX);
sprintf(myData.b, "%d", parsedY / speed);
